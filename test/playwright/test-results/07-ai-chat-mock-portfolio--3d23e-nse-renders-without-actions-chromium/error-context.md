...
- Name: 07-ai-chat-mock.spec.ts >> portfolio summary mock response renders without actions
- Location: tests/07-ai-chat-mock.spec.ts:27:5

# Error details

```
Error: locator.click: Error: strict mode violation: getByLabel('Chat input') resolved to 2 elements:
    1) <textarea rows="1" aria-label="Chat input" placeholder="Ask FinAlly…" class="max-h-24 flex-1 resize-none rounded border border-border-muted bg-surface-1 px-2 py-1.5 text-sm text-text-primary placeholder:text-text-muted focus:border-blue-primary focus:outline-none"></textarea> aka getByRole('textbox', { name: 'Chat input' })
    2) <textarea rows="1" aria-label="Chat input" placeholder="Ask FinAlly…" class="max-h-24 flex-1 resize-none rounded border border-border-muted bg-surface-1 px-2 py-1.5 text-sm text-text-primary placeholder:text-text-muted focus:border-blue-primary focus:outline-none"></textarea> aka getByPlaceholder('Ask FinAlly…').nth(1)

Call log:
  - waiting for getByLabel('Chat input')
    ...
    - main [ref=e23]:
      - region "Watchlist" [ref=e25]:
        ...
        - generic [ref=e32]:
          ...
          - button "AMZN +6.54% 197.10 Remove AMZN from watchlist" [ref=e40] [cursor=pointer]:
            - generic [ref=e41]:
              - generic [ref=e42]: AMZN
              - generic [ref=e43]: +6.54%
            - generic [ref=e44]: "197.10"
          ...
          - button "META +4.27% 521.35 Remove META from watchlist" [ref=e61] [cursor=pointer]:
            - generic [ref=e62]:
              - generic [ref=e63]: META
              - generic [ref=e64]: +4.27%
            - generic [ref=e65]: "521.35"
            - button "Remove META from watchlist" [ref=e67]: ✕
          - button "MSFT +10.57% 464.41 Remove MSFT from watchlist" [ref=e68] [cursor=pointer]:
            - generic [ref=e69]:
              - generic [ref=e70]: MSFT
              - generic [ref=e71]: +10.57%
            - generic [ref=e72]: "464.41"
            - button "Remove MSFT from watchlist" [ref=e74]: ✕
          - button "NFLX +6.50% 638.99 Remove NFLX from watchlist" [ref=e75] [cursor=pointer]:
            - generic [ref=e76]:
              - generic [ref=e77]: NFLX
              - generic [ref=e78]: +6.50%
            - generic [ref=e79]: "638.99"
            - button "Remove NFLX from watchlist" [ref=e81]: ✕
          - button "NVDA +0.19% 801.54 Remove NVDA from watchlist" [ref=e82] [cursor=pointer]:
            - generic [ref=e83]:
              - generic [ref=e84]: NVDA
              - generic [ref=e85]: +0.19%
            - generic [ref=e86]: "801.54"
            - button "Remove NVDA from watchlist" [ref=e88]: ✕
          - button "TSLA -5.18% 237.05 Remove TSLA from watchlist" [ref=e89] [cursor=pointer]:
            - generic [ref=e90]:
              - generic [ref=e91]: TSLA
              - generic [ref=e92]: "-5.18%"
            - generic [ref=e93]: "237.05"
            - button "Remove TSLA from watchlist" [ref=e95]: ✕
          - button "V +3.74% 290.47 Remove V from watchlist" [ref=e96] [cursor=pointer]:
            - generic [ref=e97]:
              - generic [ref=e98]: V
              - generic [ref=e99]: +3.74%
            - generic [ref=e100]: "290.47"
