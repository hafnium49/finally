...
- Name: 07-ai-chat-mock.spec.ts >> 'buy 9999 TSLA' yields an insufficient_cash error action
- Location: tests/07-ai-chat-mock.spec.ts:70:5
...
Call log:
  ...
  - waiting for getByTestId('watchlist-row-TSLA')
