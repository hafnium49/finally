...
Error: strict mode violation: getByTestId('watchlist-row-AAPL') resolved to 2 elements:
    1) <div tabindex="0" role="button" data-testid="watchlist-row-AAPL" class="group grid cursor-pointer grid-cols-[1fr_auto_auto_auto] items-center gap-3 border-b border-border-muted/60 px-3 py-2 font-mono text-sm transition-colors hover:bg-surface-2 ">…</div> aka getByRole('button', { name: 'AAPL -0.02% 189.97 Remove' })
  ...
  - generic [ref=e2]:
    ...
    - main [ref=e23]:
      - region "Watchlist" [ref=e25]:
        ...
        - generic [ref=e32]:
          - button "AAPL -0.02% 189.97 Remove AAPL from watchlist" [ref=e33] [cursor=pointer]:
            - generic [ref=e34]:
              - generic [ref=e35]: AAPL
              - generic [ref=e36]: "-0.02%"
            - generic [ref=e37]: "189.97"
            - button "Remove AAPL from watchlist" [ref=e39]: ✕
          - button "AMZN +0.05% 185.10 Remove AMZN from watchlist" [ref=e40] [cursor=pointer]:
            - generic [ref=e41]:
              - generic [ref=e42]: AMZN
              - generic [ref=e43]: +0.05%
            - generic [ref=e44]: "185.10"
            - button "Remove AMZN from watchlist" [ref=e46]: ✕
          - button "GOOGL +0.03% 175.06 Remove GOOGL from watchlist" [ref=e47] [cursor=pointer]:
            - generic [ref=e48]:
              - generic [ref=e49]: GOOGL
              - generic [ref=e50]: +0.03%
            - generic [ref=e51]: "175.06"
            - button "Remove GOOGL from watchlist" [ref=e53]: ✕
          - button "JPM +0.03% 195.06 Remove JPM from watchlist" [ref=e54] [cursor=pointer]:
            - generic [ref=e55]:
              - generic [ref=e56]: JPM
              - generic [ref=e57]: +0.03%
            - generic [ref=e58]: "195.06"
            - button "Remove JPM from watchlist" [ref=e60]: ✕
          - button "META +0.05% 500.25 Remove META from watchlist" [ref=e61] [cursor=pointer]:
            - generic [ref=e62]:
              - generic [ref=e63]: META
              - generic [ref=e64]: +0.05%
            - generic [ref=e65]: "500.25"
            - button "Remove META from watchlist" [ref=e67]: ✕
          - button "MSFT +0.02% 420.10 Remove MSFT from watchlist" [ref=e68] [cursor=pointer]:
            - generic [ref=e69]:
              - generic [ref=e70]: MSFT
              - generic [ref=e71]: +0.02%
            - generic [ref=e72]: "420.10"
            - button "Remove MSFT from watchlist" [ref=e74]: ✕
          - button "NFLX -0.03% 599.84 Remove NFLX from watchlist" [ref=e75] [cursor=pointer]:
            - generic [ref=e76]:
              - generic [ref=e77]: NFLX
              - generic [ref=e78]: "-0.03%"
            - generic [ref=e79]: "599.84"
            - button "Remove NFLX from watchlist" [ref=e81]: ✕
          - button "NVDA -0.01% 799.90 Remove NVDA from watchlist" [ref=e82] [cursor=pointer]:
            - generic [ref=e83]:
              - generic [ref=e84]: NVDA
              - generic [ref=e85]: "-0.01%"
            - generic [ref=e86]: "799.90"
            - button "Remove NVDA from watchlist" [ref=e88]: ✕
          - button "TSLA +0.09% 250.23 Remove TSLA from watchlist" [ref=e89] [cursor=pointer]:
            - generic [ref=e90]:
              - generic [ref=e91]: TSLA
              - generic [ref=e92]: +0.09%
            - generic [ref=e93]: "250.23"
